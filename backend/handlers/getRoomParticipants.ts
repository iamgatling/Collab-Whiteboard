...
export default (io: Server, socket: Socket, roomManager: RoomManager, supabase: SupabaseClient, logToSupabase: typeof logToSupabase, state: State) => (data: { roomId?: string }, callback: (response: { success: boolean, error?: string, participants?: any[] }) => void) => {
