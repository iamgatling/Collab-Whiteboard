  ...
  (
    ...
    try {
      ...
      async function insertendSessionAction(endSessionAction: any) {
        const { error: endLogError } = await supabase
      ...
      logToSupabase({
        ...
        message: "Exception when logging room_ended action.",
        data: {
          error: {
    ...
    try {
      ...
      logToSupabase({
        ...
        roomId: state.currentRoomId,
        userId: state.currentUserId,
        message: "Exception when logging room_ended to user_actions_log.",
        data: {
          error: {
            message: (error as Error).message,
            stack: (error as Error).stack,
